# Codex 5h / 7d 额度透支功能集成记录

本文件是维护者实现、配置与升级记录。功能移植自
[DeanZFC/sub2api-overdraft](https://github.com/DeanZFC/sub2api-overdraft)，并适配本项目的
Sub2API v0.1.177 代码及既有二次开发。
...
- 代码和部署示例默认值：关闭
- 项目品牌、镜像构建与在线更新源：保持本项目原有配置，不跟随第三方 Fork
...
移植采用第三方 Fork `0.1.177-overdraft.6` 的“独立模块 + 固定钩子”结构，以减少同步官方更新时的冲突：
