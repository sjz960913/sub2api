...
func checkColumn(t, c string) error {
	initCheck.Do(func() {
		columnCheck = sql.NewColumnCheck(map[string]func(string) bool{
			...
			collaborationcharge.Table:           collaborationcharge.ValidColumn,
			collaborationcommand.Table:          collaborationcommand.ValidColumn,
			collaborationdevice.Table:           collaborationdevice.ValidColumn,
			collaborationsyncrequest.Table:      collaborationsyncrequest.ValidColumn,
