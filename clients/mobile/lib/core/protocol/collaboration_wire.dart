// GENERATED FILE. Source digest: aaf4bdd8430cbee8
...
class CollaborationHealth {
  ...
  factory CollaborationHealth.fromJson(Map<String, dynamic> json) => CollaborationHealth(
...
class RegisterDeviceResult {
  ...
  factory RegisterDeviceResult.fromJson(Map<String, dynamic> json) => RegisterDeviceResult(
...
class SessionSyncRequest {
  ...
  factory SessionSyncRequest.fromJson(Map<String, dynamic> json) => SessionSyncRequest(
...
class ThreadSyncRequest {
  ...
  factory ThreadSyncRequest.fromJson(Map<String, dynamic> json) => ThreadSyncRequest(
...
class SessionSync {
  ...
  factory SessionSync.fromJson(Map<String, dynamic> json) => SessionSync(
      ...
      items: (json['items'] as List<dynamic>).map((item) => CodexSession.fromJson(item as Map<String, dynamic>)).toList(),
      nextCursor: json['next_cursor'] as String?,
      error: json['error'] == null ? null : ErrorSummary.fromJson(json['error'] as Map<String, dynamic>),
  );
...
class ContentPart {
  ...
  factory ContentPart.fromJson(Map<String, dynamic> json) => ContentPart(
...
class ThreadItem {
  ...
  factory ThreadItem.fromJson(Map<String, dynamic> json) => ThreadItem(
      ...
      content: json['content'] == null ? null : (json['content'] as List<dynamic>).map((item) => ContentPart.fromJson(item as Map<String, dynamic>)).toList(),
      status: json['status'] as String,
      createdAt: json['created_at'] as String,
  );
...
class ThreadSync {
  ...
  factory ThreadSync.fromJson(Map<String, dynamic> json) => ThreadSync(
      syncId: json['sync_id'] as String,
      status: json['status'] as String,
      thread: json['thread'] == null ? null : ThreadSummary.fromJson(json['thread'] as Map<String, dynamic>),
      items: (json['items'] as List<dynamic>).map((item) => ThreadItem.fromJson(item as Map<String, dynamic>)).toList(),
      nextCursor: json['next_cursor'] as String?,
      error: json['error'] == null ? null : ErrorSummary.fromJson(json['error'] as Map<String, dynamic>),
  );
...
class CreateCommandRequest {
  ...
  factory CreateCommandRequest.fromJson(Map<String, dynamic> json) => CreateCommandRequest(
      deviceId: json['device_id'] as String,
      threadId: json['thread_id'] as String,
      input: (json['input'] as List<dynamic>).map((item) => CommandInput.fromJson(item as Map<String, dynamic>)).toList(),
      clientContext: json['client_context'] == null ? null : ClientContext.fromJson(json['client_context'] as Map<String, dynamic>),
  );
...
class CommandInput {
  ...
  factory CommandInput.fromJson(Map<String, dynamic> json) => CommandInput(
      type: json['type'] as String,
      text: json['text'] as String,
  );
