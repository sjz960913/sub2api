  ...
  admin: {
    ...
    channels: {
      ...
      form: {
        ...
        codexImageGenerationBridgeHint: 'When enabled, Codex /responses text requests in OpenAI groups may be automatically given the image_generation tool. When off for this channel, client-provided image_generation tools and matching tool_choice are removed.',
    ...
    accounts: {
      ...
      openai: {
        ...
        codexImageToolDisabled: 'No injection / strip',
        codexImageToolDisabledDesc: 'Never auto-inject, and remove client-provided image tools plus matching tool_choice.',
