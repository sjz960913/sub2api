export default {
    accounts: {
      ...
      openai: {
        ...
        codexFingerprintModeDesc: 'When multiple users share the same OAuth account, converge device and session identifiers to account-level stable values. Session convergence is enabled by default; explicitly select Off if compatibility issues occur.',
