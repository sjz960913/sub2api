  ...
  admin: {
    ...
    channels: {
      ...
      form: {
        ...
        codexImageGenerationBridgeHint: '开启后，OpenAI 分组的 Codex /responses 文本请求可能会被自动注入 image_generation 工具。渠道关闭时会移除客户端自带的 image_generation 工具及对应 tool_choice。',
    ...
    accounts: {
      ...
      openai: {
        ...
        codexImageToolDisabled: '关闭/剥离',
        codexImageToolDisabledDesc: '不自动注入，并移除客户端自带的图片工具及指向它的 tool_choice。',
